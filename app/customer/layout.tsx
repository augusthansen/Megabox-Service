        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="md:hidden border-t border-slate-200 dark:border-slate-700 pt-3 pb-3">
            <div className="flex items-center justify-around">
              <Link
                href="/customer"
                className="flex flex-col items-center px-3 py-2 text-xs text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white font-medium transition-colors min-h-[44px] justify-center"
              >
